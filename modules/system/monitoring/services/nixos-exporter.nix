{
  ...
  cfg = config.myModules.system.monitoring.nixos-exporter;
in {
  options.myModules.system.monitoring.nixos-exporter = {
    enable = lib.mkEnableOption "NixOS metrics exporter";
  };
